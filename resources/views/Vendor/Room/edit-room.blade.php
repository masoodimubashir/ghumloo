        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form
                            action="{{route('vendor-room.update', [base64_encode($room->id)])}}"
                            method="POST"
                                ...
                                <select class="form-select" name="room_type_id">
                                    @if($room_types->isNotEmpty())
                                        @foreach($room_types as $room_type)
                                            <option
                                                    {{$room->roomConfiguration->room_type_id === $room_type->id ? 'selected' : ''}}
                                                    value="{{$room_type->id}}">
                                                {{$room_type->room_type}}
                                            </option>
                                        @endforeach
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="meal_type" class="form-select">
                                    ...
                                    <option {{$room->roomConfiguration->meal_type === 'ap' ? 'selected' : ''}} value="ap">
                                        AP
                                    </option>
                                    <option {{$room->roomConfiguration->meal_type === 'ep' ? 'selected' : ''}} value="ep">
                                        EP
                                    </option>
                                    <option {{$room->roomConfiguration->meal_type === 'cp' ? 'selected' : ''}} value="cp">
                                        CP
                                    </option>
                                    <option {{$room->roomConfiguration->meal_type === 'map' ? 'selected' : ''}} value="map">
                                        MAP
                                    </option>
                                </select>
                                @error('meal_type')
                            ...
                            <div class="col-md-3 ">
                                ...
                                <select name="ac" class="form-select">
                                    ...
                                    <option {{$room->roomConfiguration->ac === "ac" ? 'selected' : ''}} value="ac">
                                        AC
                                    </option>
                                    <option {{$room->roomConfiguration->ac === 'no' ? 'selected' : ''}} value="no">
                                        No Ac
                                    </option>
                                </select>
                                @error('ac')
                            ...
                            <div class="col-md-3 ">
                                ...
                                <select name="bed_id" class="form-select">
                                    ...
                                    @if($beds->isNotEmpty())
                                        @foreach($beds as $bed)
                                            <option
                                                    {{$room->roomConfiguration->bed_id === $bed->id ? 'selected' : ''}}
                                                    value="{{$bed->id}}">
                                                {{$bed->bed_type}}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="cancellation_in_days" class="form-select">
                                    ...
                                    <option
                                        {{$room->free_cancellation === 1 ? 'selected' : ''}}
                                            value="1">1
                                    </option>
                                    <option
                                        {{$room->free_cancellation === 2 ? 'selected' : ''}}
                                            value="2">2
                                    </option>
                                    <option
                                        {{$room->free_cancellation === 3 ? 'selected' : ''}}
                                            value="3">3
                                    </option>
                                    <option
                                        {{$room->free_cancellation === 4 ? 'selected' : ''}}
                                            value="4">4
                                    </option>
                                    <option
                                        {{$room->free_cancellation === 6 ? 'selected' : ''}}
                                            value="5">5
                                    </option>
                        ...
                        <div class="mt-4 p-3 rounded bg-secondary">
                            <div class="form-switch">
                                <input
                                        {{$room->free_cancellation === 1 ? 'checked' : ''}}
