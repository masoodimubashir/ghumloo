    ...
    <div class="row">
        <div class="col-12grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <h4 class="card-title col-md-10">Add Hotel</h4>
                        <a href="{{route('vendor-hotel.index')}}" class="btn btn-outline-primary col-md-2">
                            View Hotels
                        </a>
                    </div>
                    <form
                        class="forms-sample"
                        action="{{route('vendor-hotel.store')}}"
                        method="POST"
...
{{--                                                        </div>--}}
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" value="{{old('star_rating')}}" name="star_rating" placeholder="Star Rating">
                            </div>
                        </div>

                        <div class="switch mar-bot-20 ">
                            <div class=" form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="allowed_pets"
                                       id="allowed_pets">
