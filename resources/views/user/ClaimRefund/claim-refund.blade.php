    ...
    <div class="db-2">
        <div class="db-2-com db-2-main">
            ...
            <div class="db-2-main-com db-2-main-com-table db-com-p">
                <h5>Claim & Refund</h5>
                <p>search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have
                ...
                <div class="db-mak-pay-bot">
                    ...
                    <a href="db-payment.html" class="waves-effect waves-light btn-large">Make Paymeny Now</a>
                </div>
            </div>
        </div>
    </div>
